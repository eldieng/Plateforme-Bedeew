...
import { 
  ...
  Smartphone, Search, Calendar, DollarSign, Clock, FileText,
  User, Mail, Phone, Building, Sparkles, ArrowRight, Zap
} from 'lucide-react';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const dataToSend = {
        ...
        subject: `Demande de Devis - ${projectTypes.find(p => p.value === formData.projectType)?.label || 'Projet'}`,
      ...
      toast.success('🎉 Demande de devis envoyée avec succès ! Nous vous contacterons sous 24h.', {
        duration: 5000,
      });
        ...
        <div className="container relative z-10 text-center py-20">
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full mb-8">
              ...
              <span className="text-white font-medium">Devis Gratuit</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-gray-200 max-w-3xl mx-auto">
              Décrivez-nous votre projet et recevez une estimation détaillée sous 24 heures
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="bg-gradient-to-br from-primary-600 to-secondary-600 rounded-3xl shadow-xl p-8 text-white">
                <h3 className="font-bold text-xl mb-4">Ce qui se passe ensuite :</h3>
